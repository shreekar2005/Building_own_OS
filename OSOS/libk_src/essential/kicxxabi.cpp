...
/// @brief Registers a function to be called at program termination, compliant with the Itanium C++ ABI.
/// @param f Pointer to the function (destructor) to be called.
/// @param objptr Pointer to the object instance for the destructor.
/// @param dso Handle to the shared object that owns the function.
/// @return 0 on success, -1 on failure (if the table is full).
